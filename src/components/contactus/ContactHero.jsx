...
export default function ContactHero() {
  return (
    ...
    >
      ...
      {/* CONTENT */}
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 xs:px-5 sm:px-10 xl:px-16 py-12 xs:py-16 sm:py-20">
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.55, ease: [0.22, 1, 0.36, 1] }}
        >
          <p className="text-[10px] xs:text-[11px] sm:text-[12px] font-bold tracking-[0.18em] text-white uppercase mb-4">
            CONNECTING PEOPLE WITH KNOWLEDGE
          </p>

          <h1 className="text-[36px] xs:text-[42px] sm:text-[56px] lg:text-[64px] font-black text-white leading-[1.05] mb-5">
            Contact Us
          </h1>
          ...
          <div className="flex items-center gap-2.5 text-white">
            ...
            <span className="text-[14px] sm:text-[15px] font-bold">Contact Us</span>
          </div>
        </motion.div>
      </div>
    </section>
